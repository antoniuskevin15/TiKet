          ...
          <IonRow>
            <IonCol size-sm="12" size-md="8" offset-md="2">
              <IonGrid>
                ...
                <IonRow>
                  <InputControl selectedValue={mode} onSelectValue={selectModeHandler} />
                </IonRow>

                <IonList>
                  <IonLabel>
                    <b>Total Packages</b>: {packages.length}
                  </IonLabel>
                  {mode === "new" &&
                    packages?.map(
                      (p) =>
                            ...
                            <IonItem button className="item-package" href={`/user/package/detail/${p.id}/`}>
                              <IonThumbnail className="package-thumbnail" slot="start">
                                <img
                                  ...
                                  src={`${process.env.REACT_APP_WEB_URL}/storage/${p.photoPath}`}
                                />
                              </IonThumbnail>
                              <IonCardHeader>
